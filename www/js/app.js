 ...
 * Cordova-compatible version with deviceready support
 */
...
function initDOMElements() {
  ...
  cacheAgeSpan = document.getElementById('cache-age');
...
function setupEventListeners() {
  ...
  document.addEventListener('keydown', (e) => {
    if (e.key === 'Escape' && chat && chat.isStreaming) {
      chat.stopStreaming();
    }
  });
 ...
 */
function initApp() {
  console.log('Initializing OpenRouter Chat app...');
  ...
  console.log('OpenRouter Chat app initialized successfully');
}

/**
 * Wait for Cordova deviceready event or start immediately for web
 */
function startApp() {
  if (window.cordova) {
    // Running in Cordova - wait for deviceready
    document.addEventListener('deviceready', () => {
      console.log('Cordova deviceready fired');
      initApp();
    }, false);
  } else {
    // Running in browser - start immediately when DOM is ready
